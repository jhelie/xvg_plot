...
--xmax			: lower boundary of time axis (be careful to enter a number consistent with the time unit chosen!)
--xmin			: lower boundary of time axis (be careful to enter a number consistent with the time unit chosen!)
